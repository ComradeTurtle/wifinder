...
class DesktopWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("WIFINDER Desktop Console")
    ...
    def start_csv(self) -> None:
        ...
        path = Path.home() / "Downloads" / "wifinder" / f"wigle-{ts}.csv"
        self.csv_logger.start_session(path, app_release="wifinder-desktop-1")
