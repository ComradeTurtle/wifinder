...
class WigleCsvFormatterTest {
  ...
  fun `header matches wigle 1_6 format`() {
    val header = WigleCsvFormatter.header("espwigle-android")

    assertTrue(header[0].startsWith("WigleWifi-1.6,appRelease=espwigle-android"))
