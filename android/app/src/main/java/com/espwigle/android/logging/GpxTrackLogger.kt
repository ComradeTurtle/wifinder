package com.espwigle.android.logging
...
import com.espwigle.android.model.GpxTrackFormatter
...
class GpxTrackLogger(private val context: Context) {
  companion object {
    ...
    private val RELATIVE_DIR = Environment.DIRECTORY_DOWNLOADS + "/espwigle"
  }
  ...
  fun startSession(sessionId: Long, sourceTag: String): GpxSessionInfo {
    ...
    val displayPath = "Downloads/espwigle/$finalName"
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
      ...
      val baseDir =
        File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "espwigle")
      if (!baseDir.exists()) {
        baseDir.mkdirs()
      }
